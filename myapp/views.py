...
from .models import User,Product,Wishlist,Cart,Transaction,Contact,Subscribe,Review
...
def login(request):
    if request.method=="POST":
        try:
            ...
            msg="Email Or Passwor Is Incoreect"
...
def signup(request):
    if request.method=="POST":
        try:
            ...
            msg="Your Email Is Already Register"
    ...
    if request.method=="POST":
        ...
        if user.password==request.POST['old_password']:
            if request.POST['new_password']==request.POST['cnew_password']:
                ...
                msg="Password Or New Password Doesn't Match"
...
def whishlist(request):
    ...
    return render(request,'whishlist.html',{'wishlists':wishlists})
